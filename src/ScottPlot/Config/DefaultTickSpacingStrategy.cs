...
{
    public class DefaultTickSpacingStrategy : ITickSpacingStrategy
    {
        public static DefaultTickSpacingStrategy Instance { get; } = new DefaultTickSpacingStrategy();

        DefaultTickSpacingStrategy()
        {
        }
        ...
        public double GetTickSpacing(double low, double high, int maxTickCount)
        {
            ...
            int divisions = 0;
            double[] divBy = {2, 2, 2.5}; // dividing from 10 yields 5, 2.5, and 1.
